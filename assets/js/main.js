...
$(document).ready(function () {
	...
	$('.header-search').on('click', function (e) {
        ...
        $("#banner-carousel").owlCarousel({
            items: 1, // Display one item at a time (single slide)
            loop: true, // Infinite loop
            autoplay: true, // Autoplay the carousel
            autoplayTimeout: 4000, // Autoplay interval (5 seconds in this example)
            animateOut: "fadeOut", // Fade out the current slide
            animateIn: "fadeIn", // Fade in the next slide
            mouseDrag: true, // Disable mouse dragging for smoother animation
            touchDrag: true, // Disable touch dragging for smoother animation
            nav: true, // Hide navigation arrows (you can enable them if needed)
        });
